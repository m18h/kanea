...
is regenerated by the release workflow from each release's `checksums.txt` —
...
| File | Content |
|---|---|
| [`PRD.md`](./PRD.md) | Product Requirements Document — the **north star** (v1.63) |
