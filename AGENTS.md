...
**[`PRD.md`](./PRD.md) is the north star.** It is complete and internally consistent (v1.102). Every architectural decision, naming rule, milestone, and risk is specified there. When this file and the PRD disagree, the PRD wins, and the disagreement means one of them needs an amendment.
...
| File | Content |
|---|---|
| `PRD.md` | Full product requirements (v1.102), the north star |
| `AGENTS.md` | This file |
